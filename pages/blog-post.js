              ...
              <article>
                ...
                <div className="blog-excerpt">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
                    laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                ...
                <div className="comments">
                  ...
                  <ul className="comments-list">
                    <li>
                      ...
                      <div className="comment">
                        <Image className="comment-avatar pull-left" alt="" src="img/blog/user1.jpg" />
                        <div className="comment-body">
                          <div className="meta-data">
                            <span className="comment-author">Dalel Boubaker</span>
                            <span className="comment-date pull-right">January 17, 2017</span>
                          </div>
                      ...
                      <ul className="comments-reply">
                        <li>
                          {/* Comment Starts */}
                          <div className="comment">
                            <Image className="comment-avatar pull-left" alt="" src="img/blog/user2.jpg" />
                            <div className="comment-body">
                              <div className="meta-data">
                      ...
                      <div className="comment last">
                        <Image className="comment-avatar pull-left" alt="" src="img/blog/user3.jpg" />
                        <div className="comment-body">
                          <div className="meta-data">
                  ...
                  <h3 className="comments-heading uppercase add-comment">Add a comment</h3>
                  ...
                  <div className="comments-form">
                    <form role="form">
                      ...
                      <div className="form-group col-xl-12">
                        ...
                        <textarea id="comment" name="comment" className="form-control" placeholder="YOUR COMMENT" required="" defaultValue={""} />
                      </div>
